<?php
/**
 * CI-only Server-Timing emitter for Blockera performance benchmarks.
 *
 * Adapted from WordPress core tests/performance/wp-content/mu-plugins/server-timing.php.
 * Emits `wp-total` (plus front-end `wp-before-template` / `wp-template`) for the
 * Playwright performance harness and threshold compare step.
 *
 * @package Blockera
 */

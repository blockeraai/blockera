 ...
 */
if ( ! function_exists( 'blockera_test_block_latest_comments_avatar_resolve_email' ) ) {
	function blockera_test_block_latest_comments_avatar_resolve_email( $id_or_email ) {
...
if ( ! function_exists( 'blockera_test_block_latest_comments_avatar_filter_data' ) ) {
	function blockera_test_block_latest_comments_avatar_filter_data( $args, $id_or_email ) {
		$email = strtolower( trim( blockera_test_block_latest_comments_avatar_resolve_email( $id_or_email ) ) );

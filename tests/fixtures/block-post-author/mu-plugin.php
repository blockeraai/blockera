...
if ( ! function_exists( 'blockera_test_block_post_author_avatar_fixture_rel_path' ) ) {
	function blockera_test_block_post_author_avatar_fixture_rel_path() {
 ...
 */
if ( ! function_exists( 'blockera_test_block_post_author_avatar_resolve_email' ) ) {
	function blockera_test_block_post_author_avatar_resolve_email( $id_or_email ) {
 ...
 * @return array
 */
if ( ! function_exists( 'blockera_test_block_post_author_avatar_filter_data' ) ) {
	function blockera_test_block_post_author_avatar_filter_data( $args, $id_or_email ) {
		$email = strtolower( trim( blockera_test_block_post_author_avatar_resolve_email( $id_or_email ) ) );
		if ( '' === $email || 'hello@blockera.ai' !== $email ) {
			return $args;
		}

		$rel  = blockera_test_block_post_author_avatar_fixture_rel_path();
...
if ( ! has_filter( 'get_avatar_data', 'blockera_test_block_post_author_avatar_filter_data' ) ) {
	add_filter( 'get_avatar_data', 'blockera_test_block_post_author_avatar_filter_data', 10, 2 );
}

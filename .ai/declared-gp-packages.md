...
Generated by `project:bootstrap` from this product's real GP allow-list. Do not edit by hand.
...
## Jest (`config/assets.php` `list`, else `dependencies` + `devDependencies`)
...
## PHPUnit / PHPCS (`config/assets.php` `list`, else `require` + `require-dev` + coordinator/products)

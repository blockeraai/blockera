<?php
/**
 * Temporary mu-plugin to modify theme.json for text orientation tests (horizontal value)
 * This filter adds horizontal writing mode value for core/paragraph block using add_filter
...
add_filter('blockera_theme_json_data_theme', function($theme_json) {
	...
	// horizontal-tb maps to 'initial' in Blockera
	$data['styles']['blocks']['core/paragraph']['typography']['writingMode'] = 'horizontal-tb';

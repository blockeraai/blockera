	...
	test.describe('Paragraph Block', () => {
		test.describe('Simple Value', () => {
			test('Simple Value', async ({ page }) => {
				...
				const blockeraLetterSpacing1 =
					root?.blockeraLetterSpacing?.value;

				expect('2px').toEqual(blockeraLetterSpacing1);
				...
				const typographyLetterSpacing =
					root2?.typography?.letterSpacing;

				expect('3px').toEqual(typographyLetterSpacing);
				...
				const typographyLetterSpacing3 =
					root3?.typography?.letterSpacing;
				const blockeraLetterSpacing3 =

...
export const RECENTLY_CLOSED_STORAGE_KEY = 'blockera-tabs-recently-closed' as const;

/** Key for storing the recently closed tabs persistence setting (boolean) */
export const RECENTLY_CLOSED_PERSISTENCE_KEY = 'blockera-tabs-recently-closed-persistence' as const;
...
export const ICON_ONLY_PINNED_TABS_KEY = 'blockera-tabs-icon-only-pinned' as const;

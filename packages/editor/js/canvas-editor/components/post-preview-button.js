/**
 * see: @wordpress/editor/src/components/post-preview-button/index.js
 */
...
function writeInterstitialMessage(targetDocument) {
	let markup = renderToString(
		<div className="editor-post-preview-button__interstitial-message">
			...
			<p>{__('Generating preview…', 'blockera')}</p>
		</div>
	);
	...
	targetDocument.title = __('Generating preview…', 'blockera');
...
export function PostPreviewButton({
	...
	const { __unstableSaveForPreview } = useDispatch('core/editor');
	...
	const openPreviewWindow = async (event) => {
		// Blockera: Prevent of focus on preview window and refresh that because we need to override WordPress original functionalities for this component.
	...
	return (
		...
		>
			{textContent || (
				<>
					{_x('Preview', 'imperative verb', 'blockera')}

...
describe('Canvas editor testing', () => {
	...
	it.only('should rendered blockera canvas editor at the header top bar of Site Editor while switch between edit and init components', () => {
		...
		cy.get('.edit-site-layout__view-mode-toggle').click();

export default function MatrixStretchFillIcon({ direction = 'row' }) {
	if (direction === 'row') {
		return (
			<svg
				width="20"
			...
			>
				...
				<path d="M15 64C14.4477 64 14 63.5523 14 63L14 3C14 2.44771 14.4477 2 15 2L17 2C17.5523 2 18 2.44772 18 3L18 63C18 63.5523 17.5523 64 17 64H15Z" />
			</svg>
		);
	}

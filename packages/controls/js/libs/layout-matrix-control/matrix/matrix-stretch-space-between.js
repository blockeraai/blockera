export default function MatrixStretchSpaceBetweenIcon({ direction = 'row' }) {
	if (direction === 'row') {
		return (
			<svg
				width="66"
			...
			>
				...
				<path d="M61 64C60.4477 64 60 63.5523 60 63L60 3C60 2.44771 60.4477 2 61 2L63 2C63.5523 2 64 2.44772 64 3L64 63C64 63.5523 63.5523 64 63 64H61Z" />
			</svg>
		);
	}
	...
	return (
		...
		>
			...
			<path d="M2 61C2 60.4477 2.44772 60 3 60L63 60C63.5523 60 64 60.4477 64 61V63C64 63.5523 63.5523 64 63 64L3 64C2.44772 64 2 63.5523 2 63L2 61Z" />
		</svg>
	);
}

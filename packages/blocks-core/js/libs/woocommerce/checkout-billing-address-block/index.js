...
export const WooCommerceCheckoutBillingAddressBlock: BlockType = {
	name: 'blockeraWooCommerceCheckoutBillingAddressBlock',
	targetBlock: 'woocommerce/checkout-billing-address-block',
	blockeraInnerBlocks: {
		'core/heading': {
			name: 'core/heading',

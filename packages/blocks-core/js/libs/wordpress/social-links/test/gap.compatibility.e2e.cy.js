...
describe('Social Links Block → Gap → Compatibility', () => {
	...
	context('Simple Value', () => {
		it('Same row and column values', () => {
			appendBlocks(`<!-- wp:social-links {"style":{"spacing":{"blockGap":{"top":"30px","left":"30px"}}}} -->
<ul class="wp-block-social-links"><!-- wp:social-link {"url":"#1","service":"fivehundredpx"} /-->

<!-- wp:social-link {"url":"#1","service":"amazon"} /--></ul>
<!-- /wp:social-links -->
					`);
		...
		it('Different row and column values', () => {
			appendBlocks(`<!-- wp:social-links {"style":{"spacing":{"blockGap":{"top":"30px","left":"60px"}}}} -->
<ul class="wp-block-social-links"><!-- wp:social-link {"url":"#1","service":"fivehundredpx"} /-->
...
<!-- /wp:social-links -->
	...
	context('Variable Value', () => {
		it('Same row and column values', () => {
			appendBlocks(`<!-- wp:social-links {"style":{"spacing":{"blockGap":{"top":"var:preset|spacing|20","left":"var:preset|spacing|20"}}}} -->
<ul class="wp-block-social-links"><!-- wp:social-link {"url":"#1","service":"fivehundredpx"} /-->
...
<!-- /wp:social-links -->
		...
		it('Different row and column values', () => {
			appendBlocks(`<!-- wp:social-links {"style":{"spacing":{"blockGap":{"top":"var:preset|spacing|20","left":"var:preset|spacing|30"}}}} -->
<ul class="wp-block-social-links"><!-- wp:social-link {"url":"#1","service":"fivehundredpx"} /-->

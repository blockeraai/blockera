...
describe('Buttons Block → Gap → Compatibility', () => {
	beforeEach(() => {
		createPost();
	});

	it('Simple value', () => {
		appendBlocks(`<!-- wp:buttons {"style":{"spacing":{"blockGap":"30px"}}} -->
<div class="wp-block-buttons"><!-- wp:button -->
<div class="wp-block-button"><a class="wp-block-button__link wp-element-button">button1</a></div>
<!-- /wp:button -->

<!-- wp:button -->
<div class="wp-block-button"><a class="wp-block-button__link wp-element-button">button2</a></div>
<!-- /wp:button --></div>
<!-- /wp:buttons -->
					`);

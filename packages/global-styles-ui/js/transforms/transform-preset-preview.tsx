 ...
 */
import { formatPresetItemsSummary, type TransformPresetItem } from './utils';
...
function iconForFirstItem(items: TransformPresetItem[]): string {
...
/**
 * Preview for a theme.json transform preset (summary of first row + count).
 */
function TransformPresetPreview({ items, inline = false }: Props) {
...
export default memo(TransformPresetPreview);

...
use Closure;
use Exception;
use Blockera\bootstrap\Contracts\Container as ContainerContract;
use LogicException;
use ReflectionClass;
...
abstract class Application {
     ...
     * @return \Blockera\Bootstrap\Contracts\ContextualBindingBuilder
     */
    ...
    public function get( $id) {
		try {
			...
			if ($this->has($id) || $e instanceof \Exception) {
				throw $e;
			}
     ...
     *
     * @throws \Exception
     * @throws \Blockera\Bootstrap\Contracts\Container\\Exception
     */

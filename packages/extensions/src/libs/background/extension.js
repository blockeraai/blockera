		...
		return (
			...
			>
				...
				{isActiveBackground && isShowField(publisherBackground) && (
					...
					>
						<FeatureWrapper
							isActive={isActiveBackground}
							isActiveOnStates={
								publisherBackground.isActiveOnStates
							}
				...
				{isActiveBackgroundColor &&
					isShowField(publisherBackgroundColor) && (
						...
						>
							<FeatureWrapper
								isActive={isActiveBackgroundColor}
								isActiveOnStates={
									publisherBackgroundColor.isActiveOnStates
								}
								isActiveOnBreakpoints={
				...
				{isActiveBackgroundClip &&
					isShowField(publisherBackgroundClip) && (
						...
						>
							<FeatureWrapper
								isActive={isActiveBackgroundClip}
								isActiveOnStates={
									publisherBackgroundClip.isActiveOnStates
								}
								isActiveOnBreakpoints={

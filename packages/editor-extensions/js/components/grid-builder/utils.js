 ...
 */
import { calcGridTemplateAreas } from '../../libs/layout/utils.js';
...
export const generateAreas = ({
	...
	console.log(blockeraGridDirection);
	console.trace();
	...
	if (blockeraGridDirection.value === 'column') {
		const reOrderedAreaArray = [];
...
export const calcOverlapAreas = ({
	...
	const overlapAreas = blockeraGridAreas.filter((item) => {

 ...
 */
function NoJQueryPostMessageMixin(n, e) {
	var t,
		i,
		o,
		s,
		...
		window.postMessage
			? (window.addEventListener
					...
					: ((t = function (n) {
					  ...
					  (i = function (n) {
							window.detachEvent('onmessage', n);
					  })),
			  ...
			  (this[e] = function (n, e, s) {
					if ((o && (i(o), (o = null)), !n)) return !1;
					o = t(function (t) {
						switch (Object.prototype.toString.call(e)) {
							case '[object String]':
								if (e !== t.origin) return !1;
								break;
